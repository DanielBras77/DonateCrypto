...
/* Web3.utils.fromWei(campaign.balance || 0, "ether")
 -> Caso não tenha balance fica a 0, e estamos a converter Wei em ether
 A menor escala é sempre em Wei, e a maior é em ether mesmo sendo na rede Pol
*/
export default function Donate() {
    ...
    useEffect(() => {
        setMessage("Aguarde...A pesquisar campanha...");
    ...
    function btnDonateClick() {
        setMessage("Aguarde... A fazer doação...");
                ...
                <div className="row flex-lg-row-reverse align-items-center g-5">
                    ...
                    <div className="col-5 mb-5" style={{ height: 480, scrollbars: true }}>
                        ...
                        <p className="mb-3 fst-italic mt-5">
                            O que achou do projeto? Já foi arrecadado {Web3.utils.fromWei(campaign.balance || 0, "ether")} POL nesta campanha.
                            Quanto quer doar? (em POL)?
                        </p>
                        <div className="mb-3">
